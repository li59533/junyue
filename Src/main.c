...
struct  CONFIG  config={
	...
	.addr = 1,//uint8_t addr; 
	.SNnumber = 0x000000000000368,//0x6275110032120001,//0x6275110032120003,//0x5955125011120002, 03 yec-test 101
	.parity = 0, //uint8_t parity;		// =0 : n,8,1   =1: o,8,1  =2: e,8,1  
	.floatscale = {1.0f,0.15151515f,0.15151515f,1,1,1,1,1,1,1,1,1},
	...
	.DHCP = 1, //DHCP
	.APssid =   "TP-LINK_FF18E4",//"TP-LINK_FF18E4",//"Tenda_4F7AC0",//"yec-test",//"wifi-sensor",//"Tenda_1E6760",//"TP-LINK-SCZZB",//"yec-test",//"wifi-sensor",//"TP-LINK-sczzb2",//"hold-704",//"wifi-test1",//"yec-test",//"wifi-test",//"yec-test",//"zl_sensor",/////"yec-test",//"test3",//"qiangang2", //"qiangang1", //"qiangang1", /////
	...
	.TcpServer_IP =  "192.168.1.210",//"192.168.0.234",//"192.168.0.233",//"192.168.0.233",//"192.168.0.141",// "192.168.0.112",//
	.TcpServer_Port = "8712", //
