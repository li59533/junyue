...
#define SENSOR_Peripheral_Power_Port  GPIOE
#define SENSOR_Peripheral_Power_Pin		GPIO_PIN_12
#define SENSOR_Peripheral_Power_CLK_ENABLE  __HAL_RCC_GPIOE_CLK_ENABLE


void bsp_GetCpuID(uint32_t *_id);
//void Error_Handler(char *file, uint32_t line);
#define SENSOR_Peripheral_Power_Enable()  {HAL_GPIO_WritePin(SENSOR_Peripheral_Power_Port, SENSOR_Peripheral_Power_Pin,GPIO_PIN_SET);}
#define SENSOR_Peripheral_Power_Disable()  {HAL_GPIO_WritePin(SENSOR_Peripheral_Power_Port, SENSOR_Peripheral_Power_Pin,GPIO_PIN_RESET);}
